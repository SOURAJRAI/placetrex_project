...
<html lang="en">
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
	  		...
	  		<div class="img bg-wrap text-center py-4" style="background-image: url(images/bg_1.jpg);">
	  			<div class="user-logo">
	  				<div class="img" style="background-image: url(images/logo.jpg);height:80px;width:70px;"></div>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h2 class="mb-4" style="font-family:Arial Black;">Welcome to the PlaceTrex Portal</h2>
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
      <img src="images/s4.jpeg" alt="Chicago" style="width:100%;">
    </div>
