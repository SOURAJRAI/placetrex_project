...
<table style="width:100%;text-align:center;" id="customers">
 ...
 <?php
			include 'config.php';
			$sql1 = "SELECT sturegister.fname,sturegister.usn,sturegister.email, regstu.id, regstu.cid, regstu.semail, regstu.selects FROM sturegister INNER JOIN regstu ON sturegister.email=regstu.semail where regstu.cid='".$head."'";
  ...
  <tr>
    ...
    <td>
	<?php if($selects=='') {?>
	<a href="tab1.php?id=<?php echo $id; ?>" class="button button2">Select</a>
	<?php } else  if($selects=='selected'){ ?>
	Selected
	<?php } ?>
	</td>
