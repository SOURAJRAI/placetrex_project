...
th{
  ...
  <form id="contact" action="" method="post" style="margin-top:60px;">
	...
	<br><br>
 <fieldset>
      <input type="text"  placeholder="Enter the branch"  name="Branch"><br><br>
...
if(isset($_POST['dlt']))
{
	...
	$query1 = "delete from branch where id='".$selectid."'";
...
if(isset($_POST['add']))
{
	...
	include("config.php");
		...
		$Branch	=$_POST['Branch'];
		$sql1 = "select * from Branch where cmail='".$_SESSION['college']."'";    
		$result1 = mysqli_query($con,$sql1);
		$num1=mysqlI_num_rows($result1); 
		if($num1>=10)
		{
			echo "<script>
				alert('Only 10 branches allowed.');
			</script>";
			echo "<script> location.href='branch.php'; </script>";
		}
		else
		{
		$query = "insert into Branch(branch,cmail) values('".$Branch."','".$_SESSION['college']."')";
