...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
 ...
 <fieldset>
      <textarea placeholder="Enter rules" name="rule" tabindex="5"  required></textarea>
    </fieldset>
	
    <fieldset>
      <br><button name="add" type="submit" id="contact-submit" data-submit="...Sending">Add</button>
    </fieldset>
</form>
<table>
  <tr>
    ...
    <?php
include 'config.php'; 
$sql = "select * from addrule where cemail='".$_SESSION['college']."'";    
...
{ 
  ...
  <td><?php echo $sl; ?></td>
    ...
    <td><button type="submit" name="delete" class="btn"><i class="fa fa-close"></i></button></td>
	</form>
	<?php
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from addrule where id='".$selectid."'";
	mysqli_query($con,$query1) or die(mysqli_error($con));
	echo "<script> location.href='arule.php'; </script>";
}
?>
  </tr>
...
if(isset($_POST['add']))
{
	...
	include("config.php");
		...
		$query = "insert into addrule(rule,cemail) values('".$rule."','".$_SESSION['college']."')";
           
            mysqli_query($con,$query);
		
		
		echo "<script>
				alert('Rule added, Please Login.');
			</script>";
			echo "<script> location.href='arule.php'; </script>";
