...
<link rel="stylesheet" href="dem.css">
  ...
  <body>
        ...
        <ul class="list-unstyled components mb-5">
          <li class="active">
            <a href="shome.php"><span class="fa fa-home mr-3"></span> Home</a>
          </li>
          <li>
              <a href="srule.html"><span class="fa fa-newspaper-o mr-3 "></span> Rules</a>
          </li>
          <li>
            <a href="sprofile.php"><span class="fa fa-address-book mr-3"></span> My profile</a>
          </li>
          <li>
...
<tr>
<td>FIRST NAME</td>
<td><input type="text" name="First_Name" maxlength="30" style="color:black;"/>
