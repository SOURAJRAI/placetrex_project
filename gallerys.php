...
{ 
		...
		<div class="col-lg-3 col-md-4 col-xs-6 thumb">
			<a href="admin/gallery/<?php echo $photo; ?>">
				<figure><img class="img-fluid img-thumbnail" src="admin/gallery/<?php echo $photo; ?>" alt="Random Image" style="width:400px;height:180px;"></figure>
			</a>
		</div>
<?php
		}
